...
when /^prod/
  default[:etl][:data_warehouse][:jdbc_url] = "jdbc:jtds:sqlserver://iheartdw.ihrint.com:1433;databaseName=IHRDWH"
...
when /^stage/
  ...
  default[:etl][:data_warehouse][:host] = "iheartdw.ihrint.com"
  default[:etl][:data_warehouse][:port] = "1433"
  default[:etl][:data_warehouse][:batch_user_name] = "appBatch"
  default[:etl][:data_warehouse][:batch_user_password] = "i8piZZa4u"
