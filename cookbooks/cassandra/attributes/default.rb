...
default[:cassandra][:release_url]       = "files.ihrdev.com/cassandra/:version:/apache-cassandra-:version:-bin.tar.gz"
...
default[:cassandra][:streaming_socket_timeout_in_ms]	= 0
