...
default['graphite']['carbon']['max_updates_per_second'] = "500"
...
### IHR Specific
default[:graphite][:repo] = "git@github.ihrint.com:OPS/status.git"
...
default[:graphite][:amprepo] = "git@github.ihrint.com:OPS/monitoring.git"
