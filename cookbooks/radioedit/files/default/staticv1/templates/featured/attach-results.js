    ...
    (function() {
      (function() {
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          model = _ref[_i];
          __out.push('\n    <tr>\n        <td width="50"><img src="');
          __out.push(__sanitize(model.getImg(50)));
          __out.push('" width="50" height="50" style="max-width: inherit;" alt="preview"/></td>\n        <td style="vertical-align: middle;">');
          __out.push(__sanitize(model.get('kind').capitalize()));
          __out.push('</td>\n        <td style="vertical-align: middle;"><a href="#" data-callback="select" data-args="');
