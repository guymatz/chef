    ...
    return function(__obj) {
        ...
        (function() {
            (function() {
                ...
                __out.push('<table class="table-condensed">\n    <thead>\n    <tr>\n        <th colspan="7" class="switch toYear" data-date="');
                ...
                while (this.date.valueOf() < this.nextYear.valueOf()) {
                    __out.push('\n                <span class="month');
                    __out.push(__sanitize(this.renderLoopHelper(this)));
                    __out.push(' toDay" data-date="');
                    __out.push(__sanitize(this.date.format(Date.ISO8601_DATETIME)));
                    __out.push('">');
                    __out.push(__sanitize(this.date.format('{Mon}')));
                    __out.push('</span>\n\n                ');
                    this.date.advance({
                        months: 1
                    });
